            ...
            <c:forEach items="${requestScope.page.beanList}" var="customer">
                <tr class="text-center">
                    ...
                    <td>
                        ...
                        <a href="#" onclick="return trash(${customer.c_id})"style="text-decoration: none;">
...
<form action="listForm" method="post" action="<%=basePath%>/customer/findByPage.do">
    <div class="row">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="form-group form-inline">
                        <label>客户电话：</label>
                        <input type="text" name="c_telephone" class="form-control" id="c_telechone">
                    </div>
                    <br/>
                    <br/>
                    <div class="form-group form-inline">
